...
unitDefs.legendary_pulsar = tableMerge(unitDefs['armannit3'], {
...
unitDefs.legendary_bastion = tableMerge(unitDefs['legbastion'], {
...
unitDefs[legendary_bulwark] = tableMerge(unitDefs['cordoomt3'], {
...
for _, builder in pairs(builders) do
    if unitDefs[builder] then
        ...
        table.insert(
            ...
            (faction == 'arm' and legendary_pulsar)
                or (faction == 'cor' and legendary_bulwark)
                or legendary_bastion
        )
    end
end
